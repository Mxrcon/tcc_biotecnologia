\section{Referenciais Teóricos}\label{cap:referenciais_teoricos}

\subsection{Metabolitos secundários}
...
\subsubsection{\textit{Streptomyces}}
...
outros microorganismos \cite{chater2016}. segundo \citeonline{lee2020} cada indivíduo do gênero é capaz de produzir aproximadamente 30
...
\subsubsection{\textit{Kitastospora}}
Os organismos do gênero \textit{Kitasatospora} inicialmente descritos por \citeonline{omura1982kitasatosporia} e extensivamente estudados pelo seu grupo na Universidade de Kitasato
...
\subsubsection{\textit{Rhodococcus}}
...
\subsection{\textit{Brevibacillus}}
...
\citeonline{yao2020available} ressaltam a capacidade prolífica de \textit{Brevibacillus sp.} para expressão heteróloga
...
\subsubsection{\textit{Brevibacillus brevis}}

\subsection{Estudo genômico de MIB's}
