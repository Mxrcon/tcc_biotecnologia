...
- O que são esses metabólitos secundários
- Importancia deles na sobrevivencia de microrg ambientais
- Principais classes de metabólitos produzidos por bacterias
- Aplicação de metabolitos no desenvolvimento de antimicrobianos de forma geral, pois podes especificar nos proximo topicos.
