...
\begin{figure}[H]
	...
	\begin{minipage}{.5\linewidth}
		\includegraphics[height=.65\linewidth]{imagens/read\_qc/002.png}\\
	  \end{minipage}
	  \hspace{.01\linewidth}
	  \begin{minipage}{.5\linewidth}
		\includegraphics[height=.65\linewidth]{imagens/read\_qc/002trimmed.png}\\
	  \end{minipage}
	\centering
...
\begin{figure}[H]
	...
	\centering
	\begin{minipage}{.5\linewidth}
		\includegraphics[height=.65\linewidth]{imagens/read\_qc/004.png} \\
	  \end{minipage}
	  \hspace{.01\linewidth}
	  \begin{minipage}{.5\linewidth}
		\includegraphics[height=.65\linewidth]{imagens/read\_qc/004trimmed.png} \\
	  \end{minipage}
	\centering
    \begin{small}\textbf{Fonte: O Autor (2022)}\end{small}
\end{figure}
...
\begin{figure}[H]
	...
	\label{fig:quast_16}
	\centering
		\includegraphics[width=0.75\linewidth]{imagens/assembly\_qc/016assembly.png} \\
	\centering
    \begin{small}\textbf{Fonte: O Autor (2022)}\end{small}
\end{figure}
\vspace{\floatsep}
...
\begin{figure}[H]
	...
	\label{fig:quast_16}
	\centering
		\includegraphics[width=0.75\linewidth]{imagens/assembly\_qc/094assembly.png} \\
	\centering
    \begin{small}\textbf{Fonte: O Autor (2022)}\end{small}
\end{figure}
\vspace{\floatsep}
