...
\begin{table}[htb]
	...
	\begin{tabular}{lllll}
		...
		\cmidrule{2-5}
		\textbf{Estatística}                         & \textbf{bactopia\_skesa} & \textbf{bactopia\_spades} & \textbf{manual\_more\_kmers} & \textbf{manual\_spadess}\\
		\midrule
    ...
    \end{tabular}
	  ...
	  \legend{Informações obtidas a partir dos resultados do avaliador de montagem quast para a amostra 016}%
	  }
\end{table}
