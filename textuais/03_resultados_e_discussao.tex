...
As qualidades médias das sequências pode ser observada a partir dos gráficos gerados pela ferramenta
fastqc:
...
\begin{figure}[!htb]
	...
	\begin{minipage}{.45\linewidth}
		\includegraphics[height=\linewidth]{imagens/read\_qc/002.png}
	  \end{minipage}
	  \hspace{.05\linewidth}
	  \begin{minipage}{.45\linewidth}
		\includegraphics[height=\linewidth]{imagens/read\_qc/002trimmed.png}
	  \end{minipage}
...
\begin{figure}[!htb]
	...
	\centering
	\begin{minipage}{.45\linewidth}
		\includegraphics[height=\linewidth]{imagens/read\_qc/004.png}
	  \end{minipage}
	  \hspace{.05\linewidth}
	  \begin{minipage}{.45\linewidth}
		\includegraphics[height=\linewidth]{imagens/read\_qc/004trimmed.png}
	  \end{minipage}
    \begin{small}\textbf{Fonte: O Autor (2022)}\end{small}
\end{figure}
