...
\begin{anexosenv}
    ...
    % ---
    \section{Artigo do qual fiz parte}
	\includegraphics[width=0.8\linewidth]{imagens/artigo.png}
    \section{Premio conferido pelo Comitê internacional de Microbiologia de alimentos e higiene}
	Pela 3\textsuperscript{\underline{a}} melhor apresentação.
	\includegraphics[width=0.8\linewidth]{imagens/premio.png}
