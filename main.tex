...
\titulo{Predição funcional de genes de resistência em \it{Corynebacterium pseudotuberculosis biovar equi} após indução da resistência a rifampicina e enrofloxacina}
...
\include{pre-textuais/00_errata}
...
\include{pre-textuais/01_dedicatoria}
...
\include{pre-textuais/02_agradecimentos}
...
\include{pre-textuais/03_epigrafe}
...
\include{pre-textuais/04_resumos}

% ---
% Listas de siglas, tabelas e simbolos
% ---

\include{pre-textuais/05_listas}
...
% Introdução
% ----------------------------------------------------------
\include{textuais/00_introdução.tex}
% ----------------------------------------------------------
% Referenciais Teóricos
% ----------------------------------------------------------
\include{textuais/01_referenciais_teoricos.tex}
% ----------------------------------------------------------
% Resultados e Discussão
% ----------------------------------------------------------
\include{textuais/02_resultados_e_discussao.tex}
% ----------------------------------------------------------
% Considerações Finais
% ----------------------------------------------------------
\include{textuais/03_considerações_finais.tex}
% ----------------------------------------------------------
