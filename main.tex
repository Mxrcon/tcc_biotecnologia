...
\titulo{Análise genômica de bactérias potencialmente produtoras de antimicrobianos isoladas do Parque Estaudal Utinga, Pará}
...
\input{pre-textuais/01_dedicatoria}
...
\input{pre-textuais/02_agradecimentos}
...
\input{pre-textuais/03_epigrafe}
...
\input{pre-textuais/04_resumos}

% ---
% Listas de siglas, tabelas e simbolos
% ---

\input{pre-textuais/05_listas}
...
% Introdução
% ----------------------------------------------------------
\input{textuais/00_introdução.tex}
% ----------------------------------------------------------
% Referenciais Teóricos
% ----------------------------------------------------------
\input{textuais/01_referenciais_teoricos.tex}
% ----------------------------------------------------------
% Metodologia
% ----------------------------------------------------------
\input{textuais/02_metodologia.tex}
% ----------------------------------------------------------
% Resultados e Discussão
% ----------------------------------------------------------
\input{textuais/03_resultados_e_discussao.tex}
% ----------------------------------------------------------
% Considerações Finais
% ----------------------------------------------------------
\input{textuais/04_considerações_finais.tex}
% ----------------------------------------------------------
...
\begin{anexosenv}
	...
	% ---
    \chapter{Resultados importantes durante a minha graduação}
    % ---
    \section{Artigos em co-autoria}
	\includegraphics[width=0.8\linewidth]{imagens/artigo.png}
    \section{Prêmio conferido pelo Comitê internacional de Microbiologia de alimentos e higiene pela 3\textsuperscript{\underline{a}} melhor apresentação no 30 \textsuperscript{\underline{o}} Congresso Brasileiro de Microbiologia}
